...
import com.springboot.database.demo.springbootdatabasedemo.springdata.PersonSpringDataRepository;
...
public class SpringDataDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("inserting user with id 10006 -> {}",
				personJpaRepository.save(new Person(10005, "Tara Singh", "Agra", new Date())));
